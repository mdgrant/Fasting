...
study_char_cho.dat %>%
  ...
  footnote(
    general = "RCT: randomized controlle trial.",
...
Zelic 2013 reported only no significant difference between arms (for pooling imputed standard deviations assuming P = .1).
