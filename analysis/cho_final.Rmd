...
likert_cho_hung_kbl.dat %>%
  ...
  result_pack("Difference  p < 0.0001", 48, padding = 70) %>%
...
Results from Melis 2006 reported only non-signficant results and could not be included. A sensitivity analysis using multiple imputation to include the 2 studies yielded a random effects estimate for the SMD of -0.59 (95% CI, -0.83, -0.34; *I*^2^ = 74%). 
Excluding results from Wendling 2020, SMD = -0.61 (95% CI, -0.87 to -0.34), *I*^2^ = 74% (53%, 84%).
