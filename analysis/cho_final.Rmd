...
dichot_hunger <- left_join(dichot_hunger, or_hunger, by = "refid") %>%
  ...
  # exclude Naguib 2001 if in dataset (exclude volume)
  filter(refid != 5803)
...
hunger_meta.dat <- left_join(hunger_meta.dat, simp_comp.dat, by = "refid") %>% 
  # exclude Naguib 2001 small volume syrup
  filter(refid != 5803)
...
hunger_meta_comp <- metabin(cho_e, cho_n, fast_e, fast_n,
  data = hunger_meta.dat,
  studlab = study,
  sm = "OR",
  method = "MH",
  method.tau = "PM",
  hakn = FALSE,
  subset = simp_comp == "Complex",
  fixed = TRUE,
  digits = 2)

hunger_meta_simp <- metabin(cho_e, cho_n, fast_e, fast_n,
  data = hunger_meta.dat,
  studlab = study,
  sm = "OR",
  method = "MH",
  method.tau = "PM",
  hakn = FALSE,
  subset = simp_comp == "Simple",
  fixed = TRUE,
  digits = 2)

# combine
# hunger_simp_comp <- metabind(hunger_meta_comp, hunger_meta_simp, pooled = "fixed")
te_simp_comp <- c(hunger_meta_comp$TE.fixed, hunger_meta_simp$TE)
se_simp_comp <- c(hunger_meta_comp$seTE.fixed, hunger_meta_simp$seTE)
studlab_simp_comp <- c("Complex", "Simple")
placeholder <- c("                ", "                    ")
interact_dat <- tibble(te_simp_comp, se_simp_comp, studlab_simp_comp, placeholder)
inter_simp_comp <- metagen(te_simp_comp, se_simp_comp,
  studlab = studlab_simp_comp,
  backtransf = TRUE,
  sm = "OR",
  data = interact_dat
)

forest(inter_simp_comp,
  backtransf = TRUE,
  leftcols = c("studlab", "placeholder"),
  rightcols = c("effect", "ci"),
  leftlabs = c("CHO", " "),
  xlim = c(0.1, 1.5),
  at = c(0.1, 0.2, 0.4, 1, 1.5),
  print.I2 = FALSE,
  print.tau2 = FALSE,
  overall = FALSE,
  hetlab = "Interaction: "
...
Results from Naguib 2001 were not pooled due to the volume and high carbohydrate concentration (83%).
...
### Pediatric <a id="choLosl33">Peds</a>
