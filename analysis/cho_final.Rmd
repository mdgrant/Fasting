...
study_char_table %>%
  ...
  pack_top(., "Adult, Surgical", 1, 96) %>% 
  pack_sub(., "RCT", 1, 81) %>% 
  pack_sub(., "Nonrandomized Studies of Interventions", 82, 89) %>% 
  pack_sub(., "Prospective Cohort", 90, 92) %>%
  pack_sub(., "Retrospective Cohort", 93, 94) %>% 
  pack_sub(., "Case-control", 95, 95) %>% 
  pack_sub(., "Before-after", 96, 96) %>% 
  pack_top(., "Adult, Non-surgical", 97, 109) %>% 
  pack_sub(., "RCT", 97, 98) %>%
  pack_sub(., "Crossover", 99, 107) %>%
  pack_sub(., "Nonrandomized Studies of Interventions", 108, 109) %>% 
  pack_top(., "Pediatric, Surgical", 110, 116) %>% 
  pack_sub(., "RCT", 110, 114) %>% 
  pack_sub(., "Nonrandomized Studies of Interventions", 115, 115) %>% 
  pack_sub(., "Prospective Cohort", 116, 116) %>% 
  pack_top(., "Pediatric, Non-surgical", 117, 119) %>% 
  pack_sub(., "RCT", 117, 117) %>%
  pack_sub(., "Crossover", 118, 118) %>%
...
fasting_table %>%
  ...
  pack_top(., "Adult, Surgical", 1, 223) %>% 
  pack_sub(., "RCT", 1, 191) %>% 
  pack_sub(., "Nonrandomized Studies of Interventions", 192, 211) %>%
  pack_sub(., "Prospective Cohort", 212, 214) %>%
  pack_sub(., "Retrospective Cohort", 214, 219) %>% 
  pack_sub(., "Case-control", 220, 221) %>% 
  pack_sub(., "Before-after", 222, 223) %>% 
  pack_top(., "Adult, Non-surgical", 224, 255) %>% 
  pack_sub(., "RCT", 224, 228) %>%
  pack_sub(., "Crossover", 251, 250) %>%
  pack_sub(., "Nonrandomized Studies of Interventions", 251, 255) %>% 
  pack_top(., "Pediatric, Surgical", 256, 270) %>% 
  pack_sub(., "RCT", 256, 267) %>% 
  pack_sub(., "Nonrandomized Studies of Interventions", 268, 269) %>% 
  pack_sub(., "Prospective Cohort", 270, 270) %>% 
  pack_top(., "Pediatric, Non-surgical", 271, 276) %>% 
  pack_sub(., "RCT", 271, 273) %>%
  pack_sub(., "Crossover", 274, 275) %>%
...
cho_drink_table %>% 
  ...
  pack_top(., "Adult, Surgical", 1, 112) %>% 
  pack_sub(., "RCT", 1, 93) %>%
  pack_sub(., "Nonrandomized Studies of Interventions", 94, 104) %>% 
  pack_sub(., "Prospective Cohort", 105, 107) %>%
  pack_sub(., "Retrospective Cohort", 108, 110) %>% 
  pack_sub(., "Case-control", 111, 111) %>% 
  pack_sub(., "Before-after", 112, 112) %>% 
  pack_top(., "Adult, Non-surgical", 113, 138) %>% 
  pack_sub(., "RCT", 113, 114) %>%
  pack_sub(., "Crossover", 115, 133) %>%
  pack_sub(., "Nonrandomized Studies of Interventions", 134, 138) %>% 
  pack_top(., "Pediatric, Surgical", 139, 147) %>% 
  pack_sub(., "RCT", 139, 145) %>% 
  pack_sub(., "Nonrandomized Studies of Interventions", 146, 146) %>% 
  pack_sub(., "Prospective Cohort", 147, 147) %>% 
  pack_top(., "Pediatric, Non-surgical", 148, 150) %>% 
  pack_sub(., "RCT", 148, 148) %>%
  pack_sub(., "Crossover", 149, 149) %>%
  pack_sub(., "Prospective Cohort", 150, 150) %>% 
...
study_fund_table %>% 
  ...
  pack_top(., "Adult, Surgical", 1, 87) %>% 
  pack_sub(., "RCT", 1, 79) %>%
  pack_sub(., "Nonrandomized Studies of Interventions", 80, 87) %>% 
  pack_sub(., "Prospective Cohort", 88, 90) %>%
  pack_sub(., "Retrospective Cohort", 91, 92) %>% 
