...
likert_satis_kbl.dat %>%
  ...
  pack_top(., "Adult", 1, 7) %>%
  pack_sub(., "RCT", 1, 7) %>%
  result_pack("P = .03; higher satisfaction in CHO arm", 3, padding = 62) %>% 
  result_pack("No difference detected in satisfaction", 5, padding = 62) %>% 
...
### None Reported (Pediatric) <a id="choNoAspPeds"></a>
...
### Unreported (Pediatric) <a id="choUnrepAspPeds"></a>
...
### Pooled (CHO vs. water/placebo)  <a id="protComplFig14"></a>
