...
soe.dat <- readxl::read_xlsx("data/SOE_070621_final.xlsx", range = "A1:AB103", sheet = "soe_050521") %>%
  ...
  mutate(
    ...
    outcome = ifelse(outcome == "Ph", "Gastric pH", outcome),
...
<font size = 4> Table `r table_n`. Supplemental strength of evidence in studies comparing carbohydrate drinks with fasting in adults. </font>
