...
gum_thirst %>% 
  ...
  pack_sub(., "RCT", 1, 6) %>% 
  result_pack("Lower in gum arm, P < .001", 3, padding = 80) %>% 
  result_pack("Difference not detected", 5, padding = 80) %>% 
  result_pack("Less in gum arm, P = .03", 7, padding = 80) %>% 
...
## *Hunger* <a id="gumHungerRatings"></a>
...
gum_hunger %>% 
  ...
  pack_sub(., "RCT", 1, 4) %>% 
  result_pack("Difference not detected", 3, padding = 80) %>% 
  result_pack("Difference not detected", 5, padding = 80) %>% 
