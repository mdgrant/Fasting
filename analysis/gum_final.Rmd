...
## *Thirst* <a id="gumThirstRating2"></a>
...
## *Residual Gastric Volume* <a id="gumRgvTab3"></a>
...
### Pooled Results <a id="gumRgvFig2"></a>
...
### Pooled Results <a id="gumRgvFig3"></a>
...
```{r phGumMeta, include = TRUE, echo = FALSE, fig.width = 9.75, fig.height = 4.5, fig.align = "top"}
temp_ph <- readxl::read_xlsx("data/GumOutcomes_102820.xlsx", sheet = "pH", range = "A8:L39") %>% 
  janitor::clean_names()
