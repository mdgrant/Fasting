...
soe.dat <- readxl::read_xlsx("/Users/mgrant/Desktop/SOE_060522_final_mg.xlsx", range = "A1:AB110", sheet = "soe_060622") %>%
  clean_names() %>%
  mutate(
    ...
    outcome = str_replace(outcome, "Gastric ph", "Gastric pH"),
    outcome = str_replace(outcome, "Residual gastric volume", "Residual Gastric Volume"),
...
soe.dat <- soe.dat %>% 
    filter((grepl("Hunger|Thirst|Regur|Vomit|Residual|pH|Nausea|Satisfaction|Discomfort", outcome) & design %in% c("RCT","Crossover")) | grepl("Aspir", outcome)) %>% 
  # filter(grepl("Hunger|Residual", outcome)) %>%
  # remove post-op
  filter(!grepl("postop", outcome)) %>% 
  # delete "(preop)" from labels
  mutate(outcome = str_replace(outcome, "\\(preop\\)", ""))
...
<font size = 4> Ratings in the following tables are for selected important outcomes obtained from randomized controlled trials. With the exception of regurgitation, all outcomes are preoperative. Ratings for other outcomes and study designs can be found in the [Appendix](appendix.html#supplSoe). </font>
...
<font size = 4> Table `r table_n`. Summary findings and strength of evidence for relevant outcomes comparing carbohydrate-containing clear liquids with fasting in adults (randomized controlled trials except aspiration).  </font>

```{r chofasting, include = TRUE}
## (updated 2021/05/14 08:53) cho vs. fasting kable -----------------------
soe_summary %>% 
  filter(comparison == "CHO_fasting") %>% 
  select(!c(comparison, n, uspstf)) %>% 
  # slice(1,2,11) %>% 
...
cho_domain %>% 
  ...
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation.",
           number = foot_unique,
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; OR: odds ratio; SMD: standardized mean difference; MD: mean difference; CHO: carbohydrate; RCT: randomized controlled trial; NRSI: nonrandomized studies of interventions.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
cho_domain %>% 
  ...
  column_spec(3, width = "10em") %>% 
  column_spec(4:8, width = "8em") %>% 
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; RCT: randomized controlled trial.",
           number = foot_unique,
           general_title = "",  
           footnote_as_chunk = FALSE)
...
<font size = 4> Table `r table_n`. Strength of evidence for selected important preoperative (except aspiration) outcomes in randomized controlled trials comparing carbohydrate drinks with fasting in the pediatric population.  </font>
...
soe_summary %>% 
  ...
  # slice(1,2,11) %>% 
    kbl(booktabs = T, align = c("lclccll"), escape = FALSE,
  col.names = c("Outcome", "(pts)", " GRADE", "ACCF/AHA", "Importance", "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Summary", "Result Detail")) %>% 
  row_spec(0, bold = TRUE) %>% 
  add_header_above(c(" " = 1, "Studies" = 1, "Strength of Evidence" = 2, " " = 1, " " = 2), line = FALSE, bold = TRUE) %>%
  kable_styling(bootstrap_options = opt_boot, position = "left") %>% 
  kable_classic(full_width = TRUE, html_font = opt_font, position = "left", "hover") %>%
  ...
  column_spec(6, width = "24em") %>% 
  column_spec(7, width = "7em") %>% 
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; OR: odds ratio; SMD: mean difference; CHO: carbohydrate; RCT: randomized controlled trial.",
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>%  
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; CHO: carbohydrate; RCT: randomized controlled trial.",
  # alphabet = c("At time of endocoscopy = 0","'Did you feel hunger during the fasting period?'"),
  general_title = "",
  footnote_as_chunk = FALSE)
...
cho_domain %>% 
  ...
  column_spec(3, width = "10em") %>% 
  column_spec(4:8, width = "8em")
  # footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; RCT: randomized controlled trial; NRSI: nonrandomized studies of intervensions.",
  #          number = foot_unique,
  #          general_title = "",  
  #          footnote_as_chunk = FALSE)
...
<font size = 4> Table `r table_n`. Strength of evidence for selected important preoperative outcomes (except aspiration and patient satisfaction) in randomized controlled trials comparing protein drinks with fasting in adults.  </font>
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; CHO: carbohydrate; RCT: randomized controlled trial; OR: odds ratio; MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
prot_domain %>% 
  ...
  column_spec(3, width = "10em") %>% 
  column_spec(4:8, width = "8em") %>% 
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association;  ",
           number = foot_unique,
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; RCT: randomized controlled trial; CHO: carbohydrate.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
<font size = 4> Table `r table_n`. Strength of evidence for selected important preoperative outcomes (except aspiration and patient satisfaction) in randomized controlled trials including non-caloric clear liquid &ndash; fasting comparisons in adults.  </font>

```{r clearfasting, include = TRUE}
## (updated 2021/10/08 10:57) clear vs. fasting kable ---------------------
soe_summary %>% 
  filter(comparison == "clear_fast") %>% 
  select(!c(comparison, n, uspstf)) %>% 
  # slice(1,2,11) %>% 
    kbl(booktabs = T, align = c("lclccll"), escape = FALSE,
  col.names = c("Outcome", "(pts)", " GRADE", "ACCF/AHA", "Importance^1^", "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Summary", "Result Detail")) %>% 
...
<font size = 4> Table `r table_n`. GRADE domains for strength of evidence ratings in randomized controlled trials including non-caloric clear liquid &ndash; fasting comparisons in adults. </font>

```{r clearfastingDomain, include = TRUE, eval = TRUE}
## (updated 2021/05/14 08:02) prot_domain_summary --------------------------
prot_domain_summary <- domain_summary %>%
  filter(comparison == "clear_fast") %>%
  select(-summary) %>%
...
<font size = 4> Table `r table_n`. Strength of evidence for selected important preoperative outcomes (except aspiration and patient satisfaction) in randomized controlled trials including non-caloric clear liquid &ndash; fasting comparisons in children.  </font>

```{r clearfastingPeds, include = TRUE}
## (updated 2021/10/08 10:57) clear vs. fasting kable ---------------------
soe_summary %>% 
  filter(comparison == "peds_clear_fast") %>% 
  select(!c(comparison, n, uspstf)) %>% 
  # slice(1,2,11) %>% 
    kbl(booktabs = T, align = c("lclccll"), escape = FALSE,
  col.names = c("Outcome", "(pts)", " GRADE", "ACCF/AHA", "Importance^1^", "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Summary", "Result Detail")) %>% 
...
<font size = 4> Table `r table_n`. GRADE domains for strength of evidence ratings in randomized controlled trials including non-caloric clear liquid &ndash; fasting comparisons in children. </font>

```{r clearfastingDomainPeds, include = TRUE, eval = TRUE}
## (updated 2021/05/14 08:02) prot_domain_summary --------------------------
prot_domain_summary <- domain_summary %>%
  filter(comparison == "peds_clear_fast") %>%
  select(-summary) %>%
...
# **Pediatric 1 vs. 2 Hour**
```{r soePeds1hrData, include = TRUE}
## (updated 2021/05/13 11:45) soeData -------------------------------------
soe_peds1hr.dat <- readxl::read_xlsx("/Users/mgrant/Desktop/SOE_060522_final_mg.xlsx", range = "A1:AB9", sheet = "peds1hr") %>%
  clean_names() %>%
  mutate(
    n_s = paste0(n_studies, " <br/>(", n_pts, ")"),
    n = paste0(n, outcome),
...
# soe_peds1hr.dat <- soe_peds1hr.dat %>% 
    # filter((grepl("Hunger|Thirst|Regur|Vomit|Residual|pH|Nausea|Satisfaction|Discomfort", outcome) & design %in% c("RCT","Crossover")) | grepl("Aspir", outcome)) %>% 
  # filter(grepl("Hunger|Residual", outcome)) %>%
  # remove post-op
  # filter(!grepl("postop", outcome)) %>% 
...
## (updated 2021/05/13 13:48) soe_summary ---------------------------------
soe_summary_peds1hr <- soe_peds1hr.dat %>%
  select(n, comparison, outcome, n_s, grade, uspstf, acc, out_import, result_summary, result_links) %>%
  mutate(
    grade = case_when(
      grade == "very low" ~ '<span><span class="quality-sign">⨁</span><span class="quality-sign">◯</span><span class="quality-sign">◯</span><span class="quality-sign">◯</span>',
...
## (updated 2021/05/14 06:08) domain_summary ------------------------------
domain_summary_peds1hr <- soe_peds1hr.dat %>% 
  select(n, comparison, outcome, design, n_studies, n_pts, rob, consist, direct, prec, other, summary, ends_with("foot"))
  # mutate(design = str_to_sentence(design),
  #        consist_foot = ifelse(!grepl("\\.$", consist_foot) & !is.na(consist_foot), paste0(consist_foot, "."), consist_foot),
  #        direct_foot  = ifelse(!grepl("\\.$", direct_foot ) & !is.na(direct_foot ), paste0(direct_foot , "."), direct_foot ),
...
<font size = 4> Table `r table_n`. Strength of evidence for selected important outcomes comparing 1 and 2 hour clear liquid fasting.  </font>

```{r clearfastingPeds1hr, include = TRUE}
## (updated 2021/10/08 10:57) clear vs. fasting kable ---------------------
soe_summary_peds1hr %>% 
  # filter(comparison == "peds_clear_fast") %>% 
  select(!c(comparison, n, uspstf)) %>% 
...
```{r clearfastingDomainPeds1hr, include = TRUE, eval = TRUE}
## (updated 2021/05/14 08:02) prot_domain_summary --------------------------
peds1hr_domain_summary <- domain_summary_peds1hr %>%
  select(-summary) %>%
  mutate(
    design = str_replace(design, "Rct", "RCT"),
    design = str_replace(design, "[Nn]rsi", "NRSI"),
    design = str_replace(design, "cohort", "Cohort"),
    design = str_replace(design, "crossover", "Crossover"),
    design = str_replace(design, "prospective", "Prospective"),
  )
         
## (updated 2021/05/14 07:42) get list of unique footnotes ----------------
foot_unique <- peds1hr_domain_summary %>% 
  # slice(1:20) %>% 
  select(ends_with("foot")) 
...
numbers <- c(1:100)
peds1hr_domain <- peds1hr_domain_summary %>% 
  mutate(rob_let     = numbers[match(rob_foot, foot_unique)],
         consist_let = numbers[match(consist_foot, foot_unique)],
         direct_let  = numbers[match(direct_foot, foot_unique)],
         prec_let    = numbers[match(prec_foot, foot_unique)],
...
## (updated 2021/05/14 08:04) add footnotes -------------------------------
for (i in 1:nrow(peds1hr_domain)) {
  for (j in 7:11) {
    peds1hr_domain[i, j] <- ifelse(!is.na(peds1hr_domain[i, j + 10]), paste0(peds1hr_domain[i, j], "^", peds1hr_domain[i, j + 10], "^"), peds1hr_domain[i, j])
  }
}
...
soe_summary %>% 
  ...
  # pack_top(., "Gum", 7, 7) %>%
  # pack_top(., "Safety", 8, 8) %>%
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; RCT: randomized controlled trial; MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
gum_domain %>% 
  ...
  column_spec(3, width = "10em") %>% 
  column_spec(4:8, width = "8em") %>% 
  footnote(general = "GRADE: Grading of Recommendations Assessment, Development and Evaluation; ACCF/AHA; American College of Cardiology Foundation/American Heart Association; RCT: randomized controlled trials.",
           number = foot_unique,
           general_title = "",  
           footnote_as_chunk = FALSE)
