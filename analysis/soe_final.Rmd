...
soe_summary %>% 
  ...
  footnote(general = "N: studies; RGV: residual gastric volume; NRSI: nonrandomized studies of intervensions; OR: odds ratio; SMD: standardized mean difference; MD: mean difference.",
