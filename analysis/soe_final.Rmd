...
soe.dat <- readxl::read_xlsx("data/SOE_070621_final.xlsx", range = "A1:AB113", sheet = "soe_050521") %>%
  clean_names() %>%
  mutate(
...
<font size = 4> Table `r table_n`. Strength of evidence for important preoperative (except aspiration and patient satisfaction) outcomes in randomized controlled trials comparing carbohydrate drinks with fasting in adults.  </font>
...
soe_summary %>% 
  ...
  footnote(general = "OR: odds ratio; SMD: standardized mean difference; MD: mean difference; CHO: carbohydrate; RCT: randomized controlled trial; NRSI: nonrandomized study of interventions.",
           number = c("● Limited, ●● Important, ●●● Critical.",
             "One additional RCT with no events not included in the pooled result.",
                      "Two additional studies (Rizvanovic 2019, Yagmurdur 2011) favoring CHO drinks judged to be outliers were not included in the pooled result."),
           general_title = "",  
...
soe_summary %>% 
  ...
  # slice(1,2,11) %>% 
    kbl(booktabs = T, align = c("lclccll"), escape = FALSE,
  col.names = c("Outcome", "(pts)", " GRADE", "ACC/AHA", "Importance", "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Summary", "Result Detail")) %>% 
  row_spec(0, bold = TRUE) %>% 
  add_header_above(c(" " = 1, "Studies" = 1, "Strength of Evidence" = 2, " " = 1, " " = 2), line = FALSE, bold = TRUE) %>%
  kable_styling(bootstrap_options = opt_boot, position = "left") %>% 
  kable_classic(full_width = TRUE, html_font = opt_font, position = "left", "hover") %>%
  ...
  column_spec(6, width = "24em") %>% 
  column_spec(7, width = "7em") %>% 
  footnote(general = "OR: odds ratio; SMD: mean difference; CHO: carbohydrate; RCT: randomized controlled trial.",
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>%  
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "CHO: carbohydrate; RCT: randomized controlled trial.",
  # alphabet = c("At time of endocoscopy = 0","'Did you feel hunger during the fasting period?'"),
  general_title = "",
  footnote_as_chunk = FALSE)
...
cho_domain %>% 
  ...
  column_spec(3, width = "10em") %>% 
  column_spec(4:8, width = "8em")
  # footnote(general = "RCT: randomized controlled trial; NRSI: nonrandomized studies of intervensions.",
  #          number = foot_unique,
  #          general_title = "",  
  #          footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "CHO: carbohydrate; RCT: randomized controlled trial; OR: odds ratio; MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  column_spec(7, width = "7em") %>% 
  # pack_top(., "Patient Reported Outcomes", 1, 2) %>%
  footnote(general = "RCT: randomized controlled trial; CHO: carbohydrate.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
...
soe_summary %>% 
  ...
  # pack_top(., "Gum", 7, 7) %>%
  # pack_top(., "Safety", 8, 8) %>%
  footnote(general = "RCT: randomized controlled trial; MD: mean difference.",
           number = c("● Limited, ●● Important, ●●● Critical."),
           general_title = "",  
           footnote_as_chunk = FALSE)
