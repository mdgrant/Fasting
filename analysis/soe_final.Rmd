...
soe.dat <- readxl::read_xlsx("data/SOE_070621_final.xlsx", range = "A1:AB105", sheet = "soe_050521") %>%
  clean_names() %>%
  mutate(
...
soe.dat <- soe.dat %>% 
    filter((grepl("Hunger|Thirst|Regur|Vomit|Residual|pH|Nausea|Satisfaction", outcome) & design %in% c("RCT","Crossover")) | grepl("Aspir", outcome)) %>% 
