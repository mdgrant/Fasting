...
<font size = 4> Table `r table_n`. Strength of evidence for selected important preoperative (except aspiration and patient satisfaction) outcomes in randomized controlled trials comparing carbohydrate drinks with fasting in adults.  </font>
...
soe_summary %>% 
  ...
  # pack_top(., "Gum", 7, 7) %>%
  # pack_top(., "Safety", 8, 8) %>%
  footnote(general = "RCT: randomized controlled trial; SMD: standardized mean difference.",
           # alphabet = c("At time of endocoscopy = 0","'Did you feel hunger during the fasting period?'"),
           general_title = "",  
           footnote_as_chunk = FALSE)
