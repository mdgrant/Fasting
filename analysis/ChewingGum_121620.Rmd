...
gum_rgv %>% 
  ...
  add_header_above(c(" " = 3, "Chewing" = 1, " " = 1, "Time\\ \\ \\ \\ \\ " = 1, " " = 4), line = FALSE) %>% 
  add_header_above(c(" " = 4, "RGV" = 6), line = TRUE) %>% 
...
<img src="assets/gum_ph_rob_pooled_summary.svg" style="width:600px;" align="left" />

<br clear="all" />
<br>

<img src="assets/gum_ph_rob_pooled_traffic.svg" style="width:600px;" align="left" />
...
<font size = 4> Table `r table_n`. Summary and individual study risk of bias appraisals for pooled parallel randomized controlled trials (n = 4) examining residual gastric volume. </font>
...
<font size = 4> Figure `r figure_n`. Individual study risk of bias appraisal for randomized controlled trials. </font>

<img src="assets/gum_all_rob_traffic.svg" style="width:600px;" align="left" />
