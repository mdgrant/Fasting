...
```{r rgvTimeNMAmodel, include = TRUE, echo = FALSE, fig.align = 'left', fig.width = 5, fig.height = 5}
...
```{r netTimeTableRgv, include = FALSE, echo = FALSE, messages = FALSE}
rgv_re <- nma.model(
  data = rgv_time.data,
  outcome = "mean",
  N = "n",
