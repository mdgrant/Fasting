...
<font size = 4> Figure `r figure_n`. Posterior mean deviance comparison plot of consistency and inconsistency models (overall no indication for lack of consistency).  </font>
