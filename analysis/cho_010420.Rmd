...
```{r complicateMetaDichot, include = TRUE,  fig.width = 10, fig.height = 6.5, fig.align = "center"}
## (updated 2021/01/13 09:48)  --------------------------------------------
# data
# cho vs fasting
...
```{r complicateMetaDichotPlacWater, include = TRUE,  fig.width = 10, fig.height = 4, fig.align = "center"}
## (updated 2021/01/13 09:48)  --------------------------------------------
# data
# cho vs fasting
complicate_meta.dat <- or_join(dichot_complicate_or, "complicate") %>% 
