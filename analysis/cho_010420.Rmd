...
dichot_hunger %>% 
  ...
  footnote(general = "RCT: randomized controlled trial; OR: odds ratio; CHO: carbohydrate; Prot: protein.",
           alphabet = c("When outcome assessed relative to surgery (or endoscopy) where 0 is prior to induction.", 
...
```{r complicateMetaDichotDat, include = TRUE,  fig.width = 10, fig.height = 4.5, fig.align = "center"}
## (updated 2021/01/13 09:48)  --------------------------------------------
...
```{r complicateMetaDichotFast1, include = TRUE,  fig.width = 10, fig.height = 6.5, fig.align = "center"}
